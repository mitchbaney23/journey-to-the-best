...
export default function TabLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="log-workout" options={{ title: 'Log Workout', tabBarIcon: ({ color }) => <FontAwesome5 name="dumbbell" size={24} color={color} /> }} />
      <Tabs.Screen name="profile" options={{ title: 'Profile', tabBarIcon: ({ color }) => <FontAwesome5 name="user-alt" size={24} color={color} /> }} />
      <Tabs.Screen name="journey-map" options={{ href: null }} />
    </Tabs>
  );
}
